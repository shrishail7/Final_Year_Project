...
<!DOCTYPE html>
<html>
<?php $title="Smart Blood Bank Management System | index page"; ?>
<?php require 'head.php'; ?>
<body>

<div class="wrapper"  style="background: linear-gradient(90deg, #FF512F, #DD2476);" >
   ...
   <?php require 'message.php'; ?>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    <div class="card-header text-center">A-</div>
                    <div class="card-body">
                        You can give blood to A-, A+, AB- and AB+. You can receive blood from A- and O-
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                         You can give blood to B+ and AB+. You can receive blood from B+, B-, O+ and O-
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    <div class="card-header text-center">B-</div>
                    <div class="card-body">
                        You can give blood to B-, B+, AB+ and AB-. You can receive blood from B- and O-
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                         People with AB+ blood can receive blood from any blood type. This means that demand for AB+ can donate with AB only.
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    <div class="card-header text-center">AB-</div>
                    <div class="card-body"> 
                         AB- patients can receive blood from all negative blood types. AB- can give blood to both AB- and AB+ blood types.
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        Blood O+ can donate to A+, B+, AB+ and O+. Group O can donate blood to anybody. It's the universal donor.
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    <div class="card-header text-center">O-</div>
                    <div class="card-body">
                        O- can donate to A+, A-, B+, B-, AB+, AB-, O+ and O-. People with O negative blood can only receive donations from O negative donors.
    ...
    <style>
/* Add hover styles for the cards */
.card:hover {
    transform: scale(1.05); /* Increase size on hover */
    box-shadow: 0 8px 15px black ; /* Add shadow effect */
